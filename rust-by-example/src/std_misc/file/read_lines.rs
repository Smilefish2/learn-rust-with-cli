...
pub const NAME: &'static str = "rust-by-example:std_misc/file/read_lines";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/std_misc/file/read_lines.html";
