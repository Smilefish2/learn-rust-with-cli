...
pub const NAME: &str = "rust-by-example:std_misc/threads/testcase_mapreduce";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/std_misc/threads/testcase_mapreduce.html";
