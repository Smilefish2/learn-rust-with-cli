...
pub const NAME: &str = "rust-by-example:generics/phantom/testcase_units";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/generics/phantom/testcase_units.html";
