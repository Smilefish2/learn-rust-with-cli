...
pub const NAME: &'static str = "rust-by-example:generics/phantom/testcase_units";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/generics/phantom/testcase_units.html";
