...
pub const NAME: &str = "rust-by-example:generics/assoc_items/the_problem";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/generics/assoc_items/the_problem.html";
