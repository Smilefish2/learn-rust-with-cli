...
pub const NAME: &'static str = "rust-by-example:generics/assoc_items/types";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/generics/assoc_items/types.html";
