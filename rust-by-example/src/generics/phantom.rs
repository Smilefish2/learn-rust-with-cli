pub mod testcase_units;

use clap::{App, ArgMatches};

pub const NAME: &'static str = "rust-by-example:generics/phantom";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/generics/phantom.html";
