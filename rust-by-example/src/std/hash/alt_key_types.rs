...
pub const NAME: &'static str = "rust-by-example:std/hash/alt_key_types";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/std/hash/alt_key_types.html";
