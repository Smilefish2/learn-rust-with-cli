...
pub const NAME: &'static str = "rust-by-example:error/option_unwrap/map";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/option_unwrap/map.html";
