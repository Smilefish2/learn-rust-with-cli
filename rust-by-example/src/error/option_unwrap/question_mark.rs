...
pub const NAME: &'static str = "rust-by-example:error/option_unwrap/question_mark";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/option_unwrap/question_mark.html";
