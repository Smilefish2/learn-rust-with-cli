...
pub const NAME: &str = "rust-by-example:error/option_unwrap/question_mark";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/error/option_unwrap/question_mark.html";
