...
pub const NAME: &'static str = "rust-by-example:error/multiple_error_types/reenter_question_mark";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/multiple_error_types/reenter_question_mark.html";
