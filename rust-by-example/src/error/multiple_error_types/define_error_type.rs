...
pub const NAME: &str = "rust-by-example:error/multiple_error_types/define_error_type";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/error/multiple_error_types/define_error_type.html";
