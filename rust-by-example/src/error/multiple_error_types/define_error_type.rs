...
pub const NAME: &'static str = "rust-by-example:error/multiple_error_types/define_error_type";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/multiple_error_types/define_error_type.html";
