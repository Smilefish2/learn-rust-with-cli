...
pub const NAME: &str = "rust-by-example:error/result/enter_question_mark";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/error/result/enter_question_mark.html";
