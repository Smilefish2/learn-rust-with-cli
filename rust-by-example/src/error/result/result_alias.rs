...
pub const NAME: &'static str = "rust-by-example:error/result/result_alias";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/result/result_alias.html";
