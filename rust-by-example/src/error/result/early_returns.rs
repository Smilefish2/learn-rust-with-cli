...
pub const NAME: &'static str = "rust-by-example:error/result/early_returns";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/error/result/early_returns.html";
