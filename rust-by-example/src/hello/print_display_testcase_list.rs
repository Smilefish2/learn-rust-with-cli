...
pub const NAME: &'static str = "rust-by-example:hello/print/print_display/testcase_list";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/hello/print/print_display/testcase_list.html";
