...
pub const NAME: &'static str = "rust-by-example:trait/disambiguating";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/trait/disambiguating.html";
