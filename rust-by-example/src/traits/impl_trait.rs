...
pub const NAME: &'static str = "rust-by-example:trait/impl_trait";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/trait/impl_trait.html";
...
// 更重要的是，某些 Rust 类型无法写出。例如，每个闭包都有自己未命名的具体类型。
