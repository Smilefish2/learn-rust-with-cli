...
pub const NAME: &'static str = "rust-by-example:trait/supertraits";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/trait/supertraits.html";
...
pub fn sub_handler(_matches :&ArgMatches){
    println!("参见：https://rustwiki.org/zh-CN/rust-by-example/trait/supertraits.html")
}