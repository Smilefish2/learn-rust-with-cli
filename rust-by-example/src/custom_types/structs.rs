...
pub const NAME: &'static str = "rust-by-example:custom_types/structs";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/custom_types/structs.html";
