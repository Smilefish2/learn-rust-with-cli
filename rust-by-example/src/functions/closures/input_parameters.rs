...
pub const NAME: &str = "rust-by-example:fn/closures/input_parameters";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/fn/closures/input_parameters.html";
