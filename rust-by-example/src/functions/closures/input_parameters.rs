...
pub const NAME: &'static str = "rust-by-example:fn/closures/input_parameters";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/fn/closures/input_parameters.html";
