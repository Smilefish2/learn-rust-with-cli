...
pub const NAME: &str = "rust-by-example:fn/closures/closure_examples/iter_any";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/fn/closures/closure_examples/iter_any.html";
