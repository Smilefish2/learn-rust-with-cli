...
pub const NAME: &'static str = "rust-by-example:fn/closures/closure_examples/iter_find";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/fn/closures/closure_examples/iter_find.html";
