...
pub const NAME: &'static str = "rust-by-example:scope/borrow/alias";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/scope/borrow/alias.html";
...
或者说，同一时间内只允许一次可变借用。仅当最后一次使用可变引用之后，原始数据才可以再次借用。
 */
