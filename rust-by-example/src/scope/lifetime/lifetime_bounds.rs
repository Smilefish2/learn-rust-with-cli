...
pub const NAME: &'static str = "rust-by-example:scope/lifetime/lifetime_bounds";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/scope/lifetime/lifetime_bounds.html";
