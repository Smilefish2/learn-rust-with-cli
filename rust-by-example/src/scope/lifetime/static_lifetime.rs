...
pub const NAME: &'static str = "rust-by-example:scope/lifetime/static_lifetime";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/scope/lifetime/static_lifetime.html";
