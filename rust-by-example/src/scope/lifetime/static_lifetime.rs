...
pub const NAME: &str = "rust-by-example:scope/lifetime/static_lifetime";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/scope/lifetime/static_lifetime.html";
