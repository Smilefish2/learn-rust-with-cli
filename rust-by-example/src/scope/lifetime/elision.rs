...
pub const NAME: &'static str = "rust-by-example:scope/lifetime/elision";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/scope/lifetime/elision.html";
...
这种隐式添加生命周期的过程称为省略（elision）。在 Rust 使用省略 仅仅是因为这些模式太普遍了。
