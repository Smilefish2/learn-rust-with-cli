...
pub const NAME: &str = "rust-by-example:scope/lifetime/lifetime_coercion";
const ABOUT: &str = "https://rustwiki.org/zh-CN/rust-by-example/scope/lifetime/lifetime_coercion.html";
