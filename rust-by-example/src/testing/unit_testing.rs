...
pub const NAME: &'static str = "rust-by-example:testing/unit_testing";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/testing/unit_testing.html";
