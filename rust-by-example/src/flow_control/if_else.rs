...
pub const NAME: &'static str = "rust-by-example:flow_control/if_else";
const ABOUT: &'static str = "https://rustwiki.org/zh-CN/rust-by-example/flow_control/if_else.html";
